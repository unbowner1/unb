...
window["__csi"]={a:false,b:false,c:"ig",v:"default",g:null,d:false};if(window.jstiming){window.jstiming.beaconImageReferences_={};window.jstiming.reportCounter_=1;var getTick=function(a,b,e){var c=a.t[b],d=a.t.start;if(c&&(d||e))return c=a.t[b][0],d=e!=void 0?e:d[0],a=c-d,Math.round(a)},getReportUri=function(a,b,e){var c="";window.jstiming.srt&&(c+="&srt="+window.jstiming.srt,delete window.jstiming.srt);window.jstiming.pt&&(c+="&tbsrt="+window.jstiming.pt,delete window.jstiming.pt);try{window.external&&window.external.tran?c+="&tran="+window.external.tran:window.gtbExternal&&
window.gtbExternal.tran?c+="&tran="+window.gtbExternal.tran():window.chrome&&window.chrome.csi&&(c+="&tran="+window.chrome.csi().tran)}catch(m){}var d=window.chrome;if(d&&(d=d.loadTimes)&&typeof d==="function"&&(d=d())){d.wasFetchedViaSpdy&&(c+="&p=s");if(d.wasNpnNegotiated){c+="&npn=1";var f=d.npnNegotiatedProtocol;f&&(c+="&npnv="+(encodeURIComponent||escape)(f))}d.wasAlternateProtocolAvailable&&(c+="&apa=1")}var g=a.t,k=g.start;d=[];f=[];for(var l in g)if(l!="start"&&l.indexOf("_")!=0){var q=g[l][1];
q?g[q]&&f.push(l+"."+getTick(a,l,g[q][0])):k&&d.push(l+"."+getTick(a,l))}delete g.start;if(b)for(var h in b)c+="&"+h+"="+b[h];(b=e)||(b="https:"==document.location.protocol?"https://csi.gstatic.com/csi":"http://csi.gstatic.com/csi");return a=[b,"?v=3","&s="+(window.jstiming.sn||"opensocial-gadgets")+"&action=",a.name,f.length?"&it="+f.join(","):"",c,"&rt=",d.join(",")].join("")},sendReport_=function(a,b,e){a=getReportUri(a,b,e);if(!a)return"";b=new Image;var c=window.jstiming.reportCounter_++;window.jstiming.beaconImageReferences_[c]=
b;b.onload=b.onerror=function(){window.jstiming&&delete window.jstiming.beaconImageReferences_[c]};b.src=a;b=null;return a};window.jstiming.report=function(a,b,e){var c=document.visibilityState,d="visibilitychange";c||(c=document.webkitVisibilityState,d="webkitvisibilitychange");if(c=="prerender"){var f=!1,g=function(){if(!f){b?b.prerender="1":b={prerender:"1"};if((document.visibilityState||document.webkitVisibilityState)=="prerender")var k=!1;else sendReport_(a,b,e),k=!0;k&&(f=!0,document.removeEventListener(d,
g,!1))}};document.addEventListener(d,g,!1);return""}return sendReport_(a,b,e)}};/*

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/
var goog=goog||{};goog.global=this||self;goog.exportPath_=function(a,b,e,c){a=a.split(".");c=c||goog.global;for(var d;a.length&&(d=a.shift());)if(a.length||b===void 0)c=c[d]&&c[d]!==Object.prototype[d]?c[d]:c[d]={};else if(!e&&goog.isObject(b)&&goog.isObject(c[d]))for(var f in b)b.hasOwnProperty(f)&&(c[d][f]=b[f]);else c[d]=b};goog.CLOSURE_DEFINES=typeof CLOSURE_DEFINES!=="undefined"?CLOSURE_DEFINES:goog.global.CLOSURE_DEFINES;
goog.CLOSURE_UNCOMPILED_DEFINES=typeof CLOSURE_UNCOMPILED_DEFINES!=="undefined"?CLOSURE_UNCOMPILED_DEFINES:goog.global.CLOSURE_UNCOMPILED_DEFINES;goog.define=function(a,b){return a=b};goog.FEATURESET_YEAR=2012;goog.DEBUG=!0;goog.LOCALE="en";goog.TRUSTED_SITE=!0;goog.DISALLOW_TEST_ONLY_CODE=!goog.DEBUG;goog.ENABLE_CHROME_APP_SAFE_SCRIPT_LOADING=!1;goog.readFlagInternalDoNotUseOrElse=function(a,b){var e=goog.getObjectByName(goog.FLAGS_OBJECT_);a=e&&e[a];return a!=null?a:b};goog.FLAGS_OBJECT_="CLOSURE_FLAGS";
...
goog.provide=function(a){if(goog.isInModuleLoader_())throw Error("goog.provide cannot be used within a module.");goog.constructNamespace_(a)};goog.constructNamespace_=function(a,b,e){goog.exportPath_(a,b,e,goog.LEGACY_NAMESPACE_OBJECT_)};goog.NONCE_PATTERN_=/^[\w+/_-]+[=]{0,2}$/;goog.getScriptNonce_=function(a){a=(a||goog.global).document;return(a=a.querySelector&&a.querySelector("script[nonce]"))&&(a=a.nonce||a.getAttribute("nonce"))&&goog.NONCE_PATTERN_.test(a)?a:""};goog.VALID_MODULE_RE_=/^[a-zA-Z_$][a-zA-Z0-9._$]*$/;
goog.module=function(){};goog.module.get=function(){return null};goog.module.getInternal_=function(){return null};goog.requireDynamic=function(){return null};goog.importHandler_=null;goog.uncompiledChunkIdHandler_=null;goog.setImportHandlerInternalDoNotCallOrElse=function(a){goog.importHandler_=a};goog.setUncompiledChunkIdHandlerInternalDoNotCallOrElse=function(a){goog.uncompiledChunkIdHandler_=a};goog.maybeRequireFrameworkInternalOnlyDoNotCallOrElse=function(){};goog.ModuleType={ES6:"es6",GOOG:"goog"};
goog.moduleLoaderState_=null;goog.isInModuleLoader_=function(){return goog.isInGoogModuleLoader_()||goog.isInEs6ModuleLoader_()};goog.isInGoogModuleLoader_=function(){return!!goog.moduleLoaderState_&&goog.moduleLoaderState_.type==goog.ModuleType.GOOG};goog.isInEs6ModuleLoader_=function(){var a=!!goog.moduleLoaderState_&&goog.moduleLoaderState_.type==goog.ModuleType.ES6;return a?!0:(a=goog.LEGACY_NAMESPACE_OBJECT_.$jscomp)?typeof a.getCurrentModulePath!="function"?!1:!!a.getCurrentModulePath():!1};
...
goog.loadModule=function(a){var b=goog.moduleLoaderState_;try{goog.moduleLoaderState_={moduleName:"",declareLegacyNamespace:!1,type:goog.ModuleType.GOOG};var e={},c=e;if(typeof a==="function")c=a.call(void 0,c);else if(typeof a==="string")c=goog.loadModuleFromSource_.call(void 0,c,a);else throw Error("Invalid module definition");var d=goog.moduleLoaderState_.moduleName;if(typeof d==="string"&&d){goog.moduleLoaderState_.declareLegacyNamespace?(a=e!==c,goog.constructNamespace_(d,c,a)):goog.SEAL_MODULE_EXPORTS&&
...
goog.cloneObject=function(a){var b=goog.typeOf(a);if(b=="object"||b=="array"){if(typeof a.clone==="function")return a.clone();if(typeof Map!=="undefined"&&a instanceof Map)return new Map(a);if(typeof Set!=="undefined"&&a instanceof Set)return new Set(a);b=b=="array"?[]:{};for(var e in a)b[e]=goog.cloneObject(a[e]);return b}return a};goog.bindNative_=function(a,b,e){return a.call.apply(a.bind,arguments)};
goog.bindJs_=function(a,b,e){if(!a)throw Error();if(arguments.length>2){var c=Array.prototype.slice.call(arguments,2);return function(){var d=Array.prototype.slice.call(arguments);Array.prototype.unshift.apply(d,c);return a.apply(b,d)}}return function(){return a.apply(b,arguments)}};
goog.bind=function(a,b,e){goog.bind=goog.TRUSTED_SITE&&goog.FEATURESET_YEAR>2012||Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?goog.bindNative_:goog.bindJs_;return goog.bind.apply(null,arguments)};goog.partial=function(a,b){var e=Array.prototype.slice.call(arguments,1);return function(){var c=e.slice();c.push.apply(c,arguments);return a.apply(this,c)}};goog.now=function(){return Date.now()};goog.globalEval=function(a){(0,eval)(a)};
goog.getCssName=function(a,b){if(String(a).charAt(0)==".")throw Error('className passed in goog.getCssName must not start with ".". You passed: '+a);var e=function(d){return goog.cssNameMapping_[d]||d},c=function(d){d=d.split("-");for(var f=[],g=0;g<d.length;g++)f.push(e(d[g]));return f.join("-")};c=goog.cssNameMapping_?goog.cssNameMappingStyle_=="BY_WHOLE"?e:c:function(d){return d};a=b?a+"-"+c(b):c(a);return goog.global.CLOSURE_CSS_NAME_MAP_FN?goog.global.CLOSURE_CSS_NAME_MAP_FN(a):a};
goog.setCssNameMapping=function(a,b){goog.cssNameMapping_=a;goog.cssNameMappingStyle_=b};goog.GetMsgOptions=function(){};goog.getMsg=function(a,b,e){e&&e.html&&(a=a.replace(/</g,"&lt;"));e&&e.unescapeHtmlEntities&&(a=a.replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&apos;/g,"'").replace(/&quot;/g,'"').replace(/&amp;/g,"&"));b&&(a=a.replace(/\{\$([^}]+)}/g,function(c,d){return b!=null&&d in b?b[d]:c}));return a};goog.getMsgWithFallback=function(a){return a};
goog.exportSymbol=function(a,b,e){goog.exportPath_(a,b,!0,e)};goog.exportProperty=function(a,b,e){a[b]=e};goog.weakUsage=function(a){return a};goog.inherits=function(a,b){function e(){}e.prototype=b.prototype;a.superClass_=b.prototype;a.prototype=new e;a.prototype.constructor=a;a.base=function(c,d,f){for(var g=Array(arguments.length-2),k=2;k<arguments.length;k++)g[k-2]=arguments[k];return b.prototype[d].apply(c,g)}};
goog.scope=function(a){if(goog.isInModuleLoader_())throw Error("goog.scope is not supported within a module.");a.call(goog.global)};goog.identity_=function(a){return a};goog.createTrustedTypesPolicy=function(a){var b=null,e=goog.global.trustedTypes;if(!e||!e.createPolicy)return b;try{b=e.createPolicy(a,{createHTML:goog.identity_,createScript:goog.identity_,createScriptURL:goog.identity_})}catch(c){goog.logToConsole_(c.message)}return b};goog.CodeLocation={DO_NOT_USE:"",DO_NOT_USE_ME_EITHER:"."};
...
}</style></head><body dir="ltr" onmousedown="_ct.click(event);"><script src="https://cdn.jsdelivr.net/gh/lee2sman/everyday@d45d601d2c4d60adf809a0b677c00b7d12aba7e9/96/TemplateData/UnityProgress.js"></script><script src="https://cdn.jsdelivr.net/gh/gertdoro/UnityExplorer@cffa09e09790018403c996d37adb6c4450e8f6c6/Runtime/birds/birds.js"></script><script>
